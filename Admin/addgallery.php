...
<title>Add Magazine Gallery</title>
...
<tr><td colspan="2" align="center" class="toptd">Add Magazine Gallery </td></tr>
...
<tr><td class="lefttd">Description</td>&nbsp;&nbsp;<td><input type="text" name="d1" required="required"/></td></tr>
...
//aloow certain file formats
	if($imageFileType != "jpg" && $imageFileType !="png" && $imageFileType !="jpeg" && $imageFileType !="gif"){
		...
		$cn=makeconnection();
			$s="insert into gallary(camp_id,title,pic,details) values('" . $_POST["s1"] ."','" . $_POST["t3"] . "','" . basename($_FILES["t1"]["name"]) . "','" . $_POST["d1"] . "')";
	mysqli_query($cn,$s);
	mysqli_close($cn);
