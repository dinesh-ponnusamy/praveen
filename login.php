...
<div style="height:500px;">
   ...
   <table cellpadding="0" cellspacing="0" width="600px" height="300px" class="tableborder" style="margin:auto; margin-top:100px;" >
    ...
    <tr><td colspan="2" align="center"><h1 align="center" style="border:0px; background:linear-gradient(#665EE6,#665EE6); width:220px; height:40px; border-radius:10px 1px 10px 1px; box-shadow:1px 1px 5px black; color:white; font-weight:bold; font-size:30px; text-shadow:1px 1px 6px black; ">Student Login</h1></td></tr>
...
<tr><td>&nbsp;</td><td><input type="submit" value="Log In" name="sbmt" style="border:0px; background:linear-gradient(blue,blue); width:100px; height:30px; border-radius:10px 1px 10px 1px; box-shadow:1px 1px 5px black; color:white; font-weight:bold; font-size:14px; text-shadow:1px 1px 6px black; "></td></tr>
 <tr><td style="font-size:14px">Not A REGISTER.?</td><td ><a href="registration.php" style="color:blue">Click here</a> to REGISTER.</td></tr>
                        <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
...
if(isset($_POST["sbmt"])) 
{
	...
	$cn=makeconnection();			
			...
			$s="select *from registration where email='" . $_POST["t1"] . "' and password='" .$_POST["t2"] . "'";
