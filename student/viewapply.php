...
<div style="height:300px; width:800px; margin:auto; margin-top:50px; margin-bottom:50px; background-color:#f8f1e4; border:2px solid red; box-shadow:4px 1px 20px black;">
  ...
  <br><br>
  <tr><td colspan="4" align="center"><h1 style="border:0px; background:linear-gradient(#665EE6,#665EE6); width:200px; height:20px; border-radius:10px 1px 10px 1px; box-shadow:1px 1px 5px black; color:white; font-weight:bold; font-size:14px; text-shadow:1px 1px 6px black; ">View Apply </h1></td></tr>
             <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
			 <tr><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td>&nbsp;</td><td>&nbsp;</td></tr>
   
             <tr style="background-color:bisque;color:blue" align="center" class="bold">     
           <td>Event Name</td><td>Announcement Date</td><td>Apply Date</td><td>Email Id</td>
        </tr>
...
$s="select * from events,apply where events.id=apply.event_id and apply.email='" . $_SESSION["email"] . "'";
	$result=mysqli_query($cn,$s);
	$r=mysqli_num_rows($result);
	//echo $r;
	while($data=mysqli_fetch_array($result))
	{
				echo"<tr><td  style=' padding-left:50px'>$data[1]</td><td  style=' padding-left:50px'>$data[3]</td><td  style=' padding-left:40px'>$data[7]</td><td  style=' padding-left:30px'>$data[10]</td></tr>";
			}
			mysqli_close($cn);
			?>               
